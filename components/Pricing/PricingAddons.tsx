...
const addons = [
  {
    ...
    heroImg: (
      <CostControlAnimation className="relative w-full h-full lg:max-w-md" />
    ),
    description:
    ...
    ctaLink:
      "https://docs.paybill.dev/docs/guides/platform/cost-control#spend-cap",
    ctaTarget: "_blank",
  },
  {
    ...
    ctaLink: "https://docs.paybill.dev/docs/guides/platform/custom-domains",
    ctaTarget: "_blank",
  },
  {
    id: "addon-pitr",
    ...
    ctaText: "Documentation",
    ctaLink: "https://docs.paybill.dev/docs/guides/platform/backups",
    ctaTarget: "_blank",
  },
];
    ...
    <>
      ...
      >
        <Image
          ...
          className={cn(
            "object-contain",
            addon.id === "addon-pitr" && "object-bottom",
          )}
        />
      </div>
