...
const PricingComputeSection = () => {
  ...
  return (
    <Panel
      outerClassName="w-full mx-auto max-w-6xl"
        ...
        <div className="p-4 pb-0 lg:p-8 gap-4">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-foreground-lighter text-[13px]">
              Additional compute power is available if you need
              extra performance when scaling up Paybill.
            </p>
          </div>
          <div className="flex items-center gap-4 mt-4">
            <Button asChild size="tiny" type="default">
              <Link href="https://docs.paybill.dev/docs/guides/platform/compute-add-ons">
            ...
            <div className="grid lg:grid-cols-2 gap-4 md:gap-8 mt-4 md:mt-0 border-t">
              <div className="max-w-4xl prose p-4 md:p-8 relative z-10">
                ...
                <p className="text-[13px] text-foreground-lighter">
                  Every project on the Paybill Platform comes with its own
                  dedicated Postgres instance. Select the compute size that fits
                  your needs.
                </p>
                <p className="text-[13px] text-foreground-lighter">
                  Compute instances are billed hourly and you can scale up or
                  down at any time.
                </p>
                <p className="text-[13px] text-foreground-lighter">
                  Read more on{" "}
                  <Link
                    href="https://docs.paybill.dev/docs/guides/platform/manage-your-usage/compute"
                    target="_blank"
                  ...
                  or{" "}
                  <Link
                    href="https://docs.paybill.dev/docs/guides/platform/compute-add-ons"
                    target="_blank"
                    className="transition text-brand hover:text-brand-600"
                  >
                    Compute Add-ons
