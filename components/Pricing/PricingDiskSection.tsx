...
const PricingDiskSection = () => (
  <div>
        ...
        <table className="text-foreground m-0 -mt-12 lg:mt-0 w-full table-auto overflow-hidden rounded-b lg:hidden text-xs">
          {diskTypes.map((diskType, idx) => (
            <tbody key={`${diskType.name}-mobile`}>
              <tr>
                <th className="py-3 pl-4 text-left font-medium pt-16 lg:pt-3 w-[60%]">
                  Disk Type
                </th>
                <td className="px-4 py-3 text-brand pt-16 lg:pt-3">
                  {diskType.name}
                </td>
              </tr>
              <tr>
    ...
    <div className="mt-8 flex justify-center">
      ...
      >
        <Link href="https://docs.paybill.dev/docs/guides/platform/compute-and-disk#disk">
