...
const ContainerVariants = cva("relative grid gap-10", {
  variants: {
    ...
    layout: {
      ...
      "flex-row-reverse":
        "flex flex-row gap-6 flex-row-reverse justify-between",
    },
    flex: {
      true: "",
      false: "",
  ...
  (
    ...
    const renderDescription =
      description && isReactForm ? (
        ...
        <p
          className={cn(
            DescriptionVariants({ size, layout }),
    ...
    return (
      <div
        ...
        {...props}
        className={cn(
          ContainerVariants({ size, flex, align, layout }),
          className,
        )}
      >
        {flex && (
        ...
        {hasLabel || labelOptional || layout === "horizontal" ? (
          <>
            <div
              className={cn(
                LabelContainerVariants({ align, labelLayout, flex, layout }),
              )}
